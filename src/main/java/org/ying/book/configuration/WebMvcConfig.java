...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(authInterceptor).addPathPatterns("/auth/logout").addPathPatterns("/search-history").addPathPatterns("/reservation-application/**").addPathPatterns("/books/borrowing").addPathPatterns("/book-shelf").addPathPatterns("/books/reservation").addPathPatterns("/users/**");
